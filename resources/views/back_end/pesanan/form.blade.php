        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col-md">
            <?php 
              ...
              //  Membuat No Tiket Otomatis
               if ($tiket == '0001') {
                ...
                $tiket = substr($tiket, 4, 4);
                $noTiket = $nama . '000' . (int) $tiket+1;
               }
              //  ddd($noTiket)
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" id="no_tiket" name="no_tiket" value="{{ $noTiket }}" disabled>
              @error('no_tiket')
                  {{ $message }}
              @enderror
            </div>
